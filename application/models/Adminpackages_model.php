...
class Adminpackages_model extends CI_Model
{
    ...
    function addPackage($package_name,$package_desc){
		$this->db->trans_start();
        $array = array('package_name'=>$package_name,'package_desc'=>htmlspecialchars($package_desc), 'package_created_date' => config_item('current_date'),'package_status'=>'active');
		$this->db->set($array);
    ...
    function editPackage($package_id,$package_name,$package_desc){
        $this->db->trans_start();
        $array = array('package_name'=>$package_name,'package_desc'=>htmlspecialchars($package_desc));
